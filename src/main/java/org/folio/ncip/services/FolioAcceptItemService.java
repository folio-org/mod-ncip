...
public class FolioAcceptItemService extends FolioNcipService implements AcceptItemService {
	...
	public AcceptItemResponseData performService(AcceptItemInitiationData initData,
		...
		try {
			...
			JsonObject acceptItemResponseDetails = ((FolioRemoteServiceManager) serviceManager).acceptItem(initData,
					userId, requesterAgencyId.toLowerCase());
			...
			logger.error("Error performing acceptItem service", e);
			if (responseData.getProblems() == null)
